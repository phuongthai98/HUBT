...
@section('content')
    <div class="container">
        ...
        <div class="col-md-6">
            <form action="{{action('admin\Product2@store',[])}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="group1" class="form-control" value="2">
                <div class="form-group">
                ...
                <a href="{{action('admin\Product2@index',[])}}" class="btn btn-danger">Hủy bỏ</a>
