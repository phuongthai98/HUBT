...
@section('content')
    ...
    <div class="container">
        <h3 class="text-center">Ghế Gaming</h3>
        <a class="pull-left btn btn-warning" href="{{action('admin\Product3@create',[])}}" style="padding-right: 50px;"><i
            ...
            <table class="table table-bordered table-hover">
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td>
                            <form action="{{action('admin\Product3@destroy',[$v->id])}}" method="post" role="form">
                                @method('DELETE')
                                @csrf
                                <a href="{{action('admin\Product3@show',[$v->id])}}" class="btn btn-primary"><i
                                        class="glyphicon glyphicon-eye-open"></i> Xem</a>
                                <a href="{{action('admin\Product3@edit',[$v->id])}}" class="btn btn-primary"><i
