...
<!-- Mirrored from adminlte.io/themes/AdminLTE/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Apr 2020 05:03:33 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
          href="{{URL::asset('')}}Admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
          href="{{URL::asset('')}}Admin/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<div class="wrapper">
    ...
    <script src="{{URL::asset('')}}Admin/code/highcharts.js"></script>
    <script src="{{URL::asset('')}}Admin/code/modules/data.js"></script>
    <script src="{{URL::asset('')}}Admin/code/modules/drilldown.js"></script>
    <script src="{{URL::asset('')}}Admin/code/modules/exporting.js"></script>
    <script src="{{URL::asset('')}}Admin/code/modules/export-data.js"></script>
    <script src="{{URL::asset('')}}Admin/code/modules/accessibility.js"></script>
                ...
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                        ...
                                        <a href="#">
                                            <div class="pull-left">
                                                @if(Auth::user()->avatar !== null)
                                                    <img src="{{URL::asset('')}}upload/avatar/{{Auth::user()->avatar}}"
                                                         class="img-circle" width="50px" alt="User Image">
                                                @else
                                                    <img
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="dist/img/user3-128x128.jpg" class="img-circle" width="50px"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="dist/img/user4-128x128.jpg" class="img-circle" width="50px"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            @if(Auth::user()->avatar !== null)
                                <img src="{{URL::asset('')}}upload/avatar/{{Auth::user()->avatar}}"
                                     class="img-circle" width="18px" alt="User Image">
                            @else
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small>Ngày tạo tài khoản: {{Auth::user()->created_at}}</small>
                                </p>
                            </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu tree" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="glyphicon glyphicon-cog"></i> <span>QL.Nhóm Danh Mục</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{action('admin\GroupCategory@index',[])}}">
                                <i class="fa fa-circle-o"></i>Nhóm Danh Mục
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active">
                            <a href="{{action('admin\Category1@index',[])}}"><i class="fa fa-circle-o"></i>Máy tính</a>
                        </li>
                        <li class="active">
                            <a href="{{action('admin\Category2@index',[])}}">
                                <i class="fa fa-circle-o"></i>Phụ kiện
                            </a>
                        </li>
                        <li class="active">
                            <a href="{{action('admin\Category3@index',[])}}"><i class="fa fa-circle-o"></i>Ghế
                                Gaming
                            </a>
                        </li>
                        <li class="active">
                            <a href="{{action('admin\Category4@index',[])}}"><i class="fa fa-circle-o"></i>Bàn
                                Gaming
                            </a>
                        </li>
                    </ul>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active">
                            <a href="{{action('admin\Product1@index',[])}}"><i class="fa fa-circle-o"></i>Máy tính</a>
                        </li>
                        <li class="active">
                            <a href="{{action('admin\Product2@index',[])}}"><i class="fa fa-circle-o"></i>Phụ kiện</a>
                        </li>
                        <li class="active">
                            <a href="{{action('admin\Product3@index',[])}}"><i class="fa fa-circle-o"></i>Ghế Gaming</a>
                        </li>
                        <li class="active">
                            <a href="{{action('admin\Product4@index',[])}}"><i class="fa fa-circle-o"></i>Bàn Gaming</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active">
                            <a href="{{action('admin\Banner@index',[])}}">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active">
                        <a href="{{action('admin\User@index',[])}}">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active">
                        <a href="{{action('admin\Roles@index',[])}}"><i class="fa fa-circle-o"></i>Vai trò</a>
                        </li>
                    </ul>
                </li>
                <!-- TOP 10-->
                <li class="treeview">
                    <a href="">
                        ...
                        <span>Top 10 sản phẩm lượt mua</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{action('admin\Chart@chart1')}}">
                                <i class="fa fa-circle-o"></i>Máy Tính
                            </a>
                        </li>
                        <li>
                            <a href="{{action('admin\Chart@chart2')}}">
                                <i class="fa fa-circle-o"></i>Phụ Kiện
                            </a>
                        </li>
                    </ul>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-pie-chart"></i>
                        <span>Top 20 sản phẩm lượt xem</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{action('admin\Chart@chart3')}}">
                                <i class="fa fa-circle-o"></i>Máy Tính
                            </a>
                        </li>
                        <li>
                            <a href="{{action('admin\Chart@chart4')}}">
                                <i class="fa fa-circle-o"></i>Phụ Kiện
                            </a>
                        </li>
                    </ul>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{action('admin\Chart@chart')}}">
                                <i class="fa fa-circle-o"></i>Biểu đồ
                            </a>
                        </li>
                    </ul>
                </li>
...
<!-- datepicker -->
<script
    src="{{URL::asset('')}}Admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<!-- Mirrored from adminlte.io/themes/AdminLTE/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Apr 2020 05:03:47 GMT -->
</html>
