...
@section('content')
    ...
    <div class="col-md-6">
        <form action="{{action('admin\Category1@update',[$data->id])}}" method="POST" onsubmit="button.disabled = true; return true;">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" value="1" name="group_category" readonly>
            </div>
            <div class="form-group">
            ...
            <a href="{{action('admin\Category1@index',[])}}" class="btn btn-danger">Hủy bỏ</a>
