...
@section('content')
    ...
    <div class="col-md-6">
        <form action="{{action('admin\Category3@update',[$data->id])}}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" value="7" name="group_category" readonly>
            </div>
            <div class="form-group">
            ...
            <a href="{{action('admin\Category3@index',[])}}" class="btn btn-danger">Hủy bỏ</a>
